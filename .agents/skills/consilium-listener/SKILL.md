...
6. Publier la réponse avec `post_message`. Lire les `messages` de rattrapage qu’il renvoie (ils ont été publiés pendant la préparation de la réponse), puis reprendre l’écoute avec son `cursor` renvoyé.
